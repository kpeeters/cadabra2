...
class Ex {
	...
	private:
		...
		// Set '_' equal to this object. Not using this anymore, as it is
		// a very bad idea to let all expressions register in this way,
		// even if they do not get generated by a shell. On top, this code
		// is broken, as it copies the C++ pointer, not the Python object,
		// so you end up with the possibility of a temporary Ex going away
		// while their is still a reference on the locals stack.
