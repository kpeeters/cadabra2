...
const std::unordered_set<std::string> functions = {
	...
	"breakpoint", "callable", "chr", "compile", "delattr", "dir", "divmod", "eval", 
	"exec", "format", "getattr", "globals", "hasattr", "hash", "hex", "id", 
	"input", "isinstance", "issubclass", "iter", "len", "locals", "max", "min", 
	"next", "oct", "open", "ord", "pow", "print", "repr", "round", "setattr", 
	"sorted", "sum", "vars", "asym", "canonicalise", "collect_components", 
	"collect_factors", "collect_terms", "combine", "compile_package__", "complete", 
	...
	"lr_tensor", "map_sympy", "order", "product_rule", "properties", 
	...
	"young_project", "young_project_product", "young_project_tensor", 
	"young_reduce", "zoom", 
};
...
const std::unordered_set<std::string> classes = {
	...
	"Coordinate", "DAntiSymmetric", "Depends", "DependsBase", "Derivative", 
	"Determinant", "Diagonal", "DifferentialForm", "DifferentialFormBase", 
	"DiracBar", "Distributable", "EpsilonTensor", "Ex", "ExNode", 
	"ExteriorDerivative", "FilledTableau", "GammaMatrix", "ImaginaryI", 
	...
	"SelfCommuting", "SelfCommutingBehaviour", "SelfNonCommuting", "SortOrder", 
	"Spinor", "Stopwatch", "Symbol", "Symmetric", "SympyBridge", "Tableau", 
	"TableauBase", "TableauObserver", "TableauSymmetry", "Total", "Trace", 
	"Traceless", "Vielbein", "Weight", "WeightBase", "WeightInherit", "WeylTensor", 
	"labelled_property", "list_property", "parent_rel_t", "result_t", 
	"scalar_backend_t", 
};
