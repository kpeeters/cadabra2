...
namespace cadabra {
	...
	private:
		...
		void setup_menus();
		void add_action_to_actiongroup(
			Glib::RefPtr<Gtk::Action> action,
			void(NotebookWindow::* callback)(void),
			const char* accel_key);
		Glib::RefPtr<Gtk::Action> menu_add_action(
			const char* name,
			const char* label,
			void(NotebookWindow::* callback)(void) = nullptr,
			const char* accel_key = nullptr);
		Glib::RefPtr<Gtk::Action> menu_add_action(
			const char* name,
		...
		Glib::RefPtr<Gtk::Action> menu_add_action(
			...
			void(NotebookWindow::* callback)(void) = nullptr,
			const char* accel_key = nullptr);
		Glib::RefPtr<Gtk::RadioAction> menu_add_radioaction(
			const char* name,
			const char* label,
		...
		// compute thread and then updated into the gui on the gui thread.s
		...
		void on_view_split();
		void on_view_close();
		void on_view_set_console_vis(Glib::RefPtr<Gtk::RadioAction> opt);
		void on_view_set_font();
		void on_view_set_text_colour();
		void on_view_set_syntax_hl(Glib::RefPtr<Gtk::RadioAction> opt);
		void on_view_customize_syntax_hl();
		void on_view_set_selection_colour(Glib::RefPtr<Gtk::RadioAction> opt);
		void on_view_set_output_size(Glib::RefPtr<Gtk::RadioAction> opt);
		void on_view_reset_to_defaults();
		...
		void on_compare_to_file();
		void on_compare_git_latest();
		void on_compare_git_choose();
		void on_compare_git_specific();
		void on_compare_select_git_executable();

		void on_help_about();
		void on_help();

		// Misc styling options
		void set_output_size(int num);
