...
if(EXISTS "/etc/redhat-release")
  ...
  if(LINUX_ISSUE MATCHES "Fedora")
    ...
    elseif(LINUX_ISSUE MATCHES "42")
      ...
      set(CPACK_RPM_PACKAGE_REQUIRES   "python3-libs, gmp, libuuid, sqlite, gtkmm30, openssl, boost-system, boost-filesystem, boost-program-options, boost-regex, libstdc++, python3-matplotlib, python3-sympy")
      set(CPACK_SYSTEM_NAME "fedora42")
    else()	
  ...
  if(EXISTS "/etc/os-release")
    ...
    if(LINUX_ISSUE MATCHES "Tumbleweed")
      ...
      set(CPACK_RPM_PACKAGE_REQUIRES   "libpython3_13-1_0, libgmp10, libuuid1, libgtkmm-3_0-1, openssl, libboost_system1_86_0, libboost_filesystem1_86_0, libboost_program_options1_86_0, libboost_regex1_86_0, libstdc++6, python313-matplotlib, python313-sympy")
    endif()
  endif()
  if(EXISTS "/etc/issue")
