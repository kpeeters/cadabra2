     ...
     file(READ "/etc/os-release" LINUX_ISSUE)
	  ...
	  if(LINUX_ISSUE MATCHES "Tumbleweed")
   	 set(CPACK_SYSTEM_NAME "tumbleweed")
		 ...
		 set(CPACK_RPM_PACKAGE_REQUIRES   "libpython3_7m1_0, libpcre1, libgmp10, libuuid1, libsqlite3-0, libgtkmm-3_0-1, libboost_system1_69_0, libboost_filesystem1_69_0, libboost_program_options1_69_0, libboost_regex1_69_0, libstdc++6, python3-matplotlib, python3-sympy, texlive-dvipng, texlive")
	  endif()
	endif()
   if(EXISTS "/etc/issue")
