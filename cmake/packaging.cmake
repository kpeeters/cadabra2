...
if(EXISTS "/etc/redhat-release")
  ...
  if(LINUX_ISSUE MATCHES "Fedora")
    set(CPACK_GENERATOR   "RPM")
    # /etc/redhat-release reads "Fedora release NN (Name)". Match that number
    # rather than testing for each release in turn. The per-release branches
    # were identical apart from the number, so every new Fedora failed the
    # configure step until a branch was added for it.
    string(REGEX MATCH "Fedora release ([0-9]+)" FEDORA_RELEASE_MATCH "${LINUX_ISSUE}")
    if(NOT FEDORA_RELEASE_MATCH)
      message(FATAL_ERROR "-- Cannot read the Fedora release number from /etc/redhat-release.")
    endif()
    set(FEDORA_VERSION "${CMAKE_MATCH_1}")
    if(FEDORA_VERSION LESS 40)
      message(FATAL_ERROR "-- This is Fedora ${FEDORA_VERSION}. Packaging is supported for Fedora 40 and later only.")
    endif()
    message("-- This is a Fedora ${FEDORA_VERSION} system")
    ...
    set(CPACK_SYSTEM_NAME "fedora${FEDORA_VERSION}-${STANDARD_ARCH_NAME}")
  endif()
else()
