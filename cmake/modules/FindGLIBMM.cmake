if(WIN32)
  ...
  if(MACOS)
    execute_process(COMMAND breq --prefix glibmm@2.64  OUTPUT_VARIABLE GLIBMM_PREFIX)
    execute_process(COMMAND breq --prefix cairomm@1.14 OUTPUT_VARIABLE CAIROMM_PREFIX)
    execute_process(COMMAND breq --prefix pangomm@2.42 OUTPUT_VARIABLE PANGOMM_PREFIX)
    execute_process(COMMAND breq --prefix atkmm@2.28   OUTPUT_VARIABLE ATKMM_PREFIX)    
