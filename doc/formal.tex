...
{\Large\larger\bf Cadabra II: a new tensor computer algebra system}\\[7ex]
...
\subsection{Make the take/replace match logic more central}
...
\subsection{Infer rules for tensors with different index positions}
